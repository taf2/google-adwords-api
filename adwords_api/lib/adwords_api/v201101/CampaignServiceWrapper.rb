require 'adwords_api/v201101/ServicedWrapperBase.rb'
  ...
  # library setup.
  require 'adwords_api/v201101/CampaignServiceDriver.rb'

  module AdwordsApi
    module V201101
      module CampaignService

        # Wrapper class for the v201101 CampaignService service.
        # This class is automatically generated.
        class CampaignServiceWrapper < ServerWrapperBase
          ...
          REGISTRY = AdwordsApi::V201101::CampaignService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201101::CampaignService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201101::CampaignService
            @version = :v201101
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201101/CampaignService.html#get] method of the CampaignService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/CampaignService.html#get].
          #
          # Args:
          ...
          def get(serviceSelector)
            begin
              arg_array = []
                validate_object(serviceSelector, AdwordsApi::V201101::CampaignService::Selector)
                arg_array << convert_to_object(serviceSelector, AdwordsApi::V201101::CampaignService::Get,
                    'serviceSelector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::CampaignService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201101/CampaignService.html#mutate] method of the CampaignService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/CampaignService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201101::CampaignService::CampaignOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201101::CampaignService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::CampaignService::Mutate.new(*arg_array)
