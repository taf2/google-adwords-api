require 'adwords_api/v201101/ServicedWrapperBase.rb'
  ...
  # library setup.
  require 'adwords_api/v201101/ReportDefinitionServiceDriver.rb'

  module AdwordsApi
    module V201101
      module ReportDefinitionService

        # Wrapper class for the v201101 ReportDefinitionService service.
        # This class is automatically generated.
        class ReportDefinitionServiceWrapper < ServerWrapperBase
          ...
          REGISTRY = AdwordsApi::V201101::ReportDefinitionService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201101::ReportDefinitionService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201101::ReportDefinitionService
            @version = :v201101
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201101/ReportDefinitionService.html#get] method of the ReportDefinitionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/ReportDefinitionService.html#get].
          #
          # Args:
            # - selector: AdwordsApi::V201101::ReportDefinitionService::ReportDefinitionSelector
            #
            # Returns:
            # - rval: AdwordsApi::V201101::ReportDefinitionService::ReportDefinitionPage
          #
          # Raises:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201101::ReportDefinitionService::ReportDefinitionSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201101::ReportDefinitionService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::ReportDefinitionService::Get.new(*arg_array)
          ...
          # Calls the {getReportFields}[http://code.google.com/apis/adwords/docs/reference/v201101/ReportDefinitionService.html#getReportFields] method of the ReportDefinitionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/ReportDefinitionService.html#getReportFields].
          #
          # Args:
            # - reportType: AdwordsApi::V201101::ReportDefinitionService::ReportDefinitionReportType
            #
            # Returns:
            # - rval: SOAP::SOAPArray of AdwordsApi::V201101::ReportDefinitionService::ReportDefinitionField
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def getReportFields(reportType)
            begin
              arg_array = []
                validate_object(reportType, AdwordsApi::V201101::ReportDefinitionService::ReportDefinitionReportType)
                arg_array << convert_to_object(reportType, AdwordsApi::V201101::ReportDefinitionService::GetReportFields,
                    'reportType')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::ReportDefinitionService::GetReportFields.new(*arg_array)
              reply = convert_from_object(@driver.getReportFields(obj))
              reply = reply[:rval] if reply.include?(:rval)
              return reply
            rescue SOAP::FaultError => fault
              raise AdwordsApi::Errors.create_api_exception(fault,
          ...
          alias get_report_fields getReportFields


          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201101/ReportDefinitionService.html#mutate] method of the ReportDefinitionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/ReportDefinitionService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201101::ReportDefinitionService::ReportDefinitionOperation
            #
            # Returns:
            # - rval: SOAP::SOAPArray of AdwordsApi::V201101::ReportDefinitionService::ReportDefinition
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201101::ReportDefinitionService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::ReportDefinitionService::Mutate.new(*arg_array)
