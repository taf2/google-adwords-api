require 'adwords_api/v201101/ServicedWrapperBase.rb'
  ...
  # library setup.
  require 'adwords_api/v201101/ExperimentServiceDriver.rb'

  module AdwordsApi
    module V201101
      module ExperimentService

        # Wrapper class for the v201101 ExperimentService service.
        # This class is automatically generated.
        class ExperimentServiceWrapper < ServerWrapperBase
          ...
          REGISTRY = AdwordsApi::V201101::ExperimentService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201101::ExperimentService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201101::ExperimentService
            @version = :v201101
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201101/ExperimentService.html#get] method of the ExperimentService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/ExperimentService.html#get].
          #
          # Args:
            # - serviceSelector: AdwordsApi::V201101::ExperimentService::Selector
            #
            # Returns:
            # - rval: AdwordsApi::V201101::ExperimentService::ExperimentPage
          #
          # Raises:
          ...
          def get(serviceSelector)
            begin
              arg_array = []
                validate_object(serviceSelector, AdwordsApi::V201101::ExperimentService::Selector)
                arg_array << convert_to_object(serviceSelector, AdwordsApi::V201101::ExperimentService::Get,
                    'serviceSelector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::ExperimentService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201101/ExperimentService.html#mutate] method of the ExperimentService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/ExperimentService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201101::ExperimentService::ExperimentOperation
            #
            # Returns:
            # - rval: AdwordsApi::V201101::ExperimentService::ExperimentReturnValue
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201101::ExperimentService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::ExperimentService::Mutate.new(*arg_array)
