require 'adwords_api/v201101/ServicedWrapperBase.rb'
  ...
  # library setup.
  require 'adwords_api/v201101/DataServiceDriver.rb'

  module AdwordsApi
    module V201101
      module DataService

        # Wrapper class for the v201101 DataService service.
        # This class is automatically generated.
        class DataServiceWrapper < ServerWrapperBase
          ...
          REGISTRY = AdwordsApi::V201101::DataService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201101::DataService::ClassName
          # This will make it easier to migrate your code between API versions.
          attr_reader :module

          public

          # Constructor for DataServiceWrapper.
          #
          # Args:
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201101::DataService
            @version = :v201101
            @service = :DataService
          end
          ...
          # Calls the {getAdGroupBidLandscape}[http://code.google.com/apis/adwords/docs/reference/v201101/DataService.html#getAdGroupBidLandscape] method of the DataService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/DataService.html#getAdGroupBidLandscape].
          #
          # Args:
          ...
          #
          def getAdGroupBidLandscape(serviceSelector)
            begin
              arg_array = []
                validate_object(serviceSelector, AdwordsApi::V201101::DataService::Selector)
                arg_array << convert_to_object(serviceSelector, AdwordsApi::V201101::DataService::GetAdGroupBidLandscape,
                    'serviceSelector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::DataService::GetAdGroupBidLandscape.new(*arg_array)
              reply = convert_from_object(@driver.getAdGroupBidLandscape(obj))
          ...
          alias get_ad_group_bid_landscape getAdGroupBidLandscape


          # Calls the {getCriterionBidLandscape}[http://code.google.com/apis/adwords/docs/reference/v201101/DataService.html#getCriterionBidLandscape] method of the DataService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/DataService.html#getCriterionBidLandscape].
          #
          # Args:
            # - serviceSelector: AdwordsApi::V201101::DataService::Selector
            #
          ...
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def getCriterionBidLandscape(serviceSelector)
            begin
              arg_array = []
                validate_object(serviceSelector, AdwordsApi::V201101::DataService::Selector)
                arg_array << convert_to_object(serviceSelector, AdwordsApi::V201101::DataService::GetCriterionBidLandscape,
                    'serviceSelector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::DataService::GetCriterionBidLandscape.new(*arg_array)
              reply = convert_from_object(@driver.getCriterionBidLandscape(obj))
              reply = reply[:rval] if reply.include?(:rval)
              return reply
            rescue SOAP::FaultError => fault
              raise AdwordsApi::Errors.create_api_exception(fault,
          ...
          alias get_criterion_bid_landscape getCriterionBidLandscape
