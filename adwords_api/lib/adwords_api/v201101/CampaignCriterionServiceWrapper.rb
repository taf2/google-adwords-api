require 'adwords_api/v201101/ServicedWrapperBase.rb'
  ...
  # library setup.
  require 'adwords_api/v201101/CampaignCriterionServiceDriver.rb'

  module AdwordsApi
    module V201101
      module CampaignCriterionService

        # Wrapper class for the v201101 CampaignCriterionService service.
        # This class is automatically generated.
        class CampaignCriterionServiceWrapper < ServerWrapperBase
          ...
          REGISTRY = AdwordsApi::V201101::CampaignCriterionService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201101::CampaignCriterionService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201101::CampaignCriterionService
            @version = :v201101
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201101/CampaignCriterionService.html#get] method of the CampaignCriterionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/CampaignCriterionService.html#get].
          #
          # Args:
          ...
          def get(serviceSelector)
            begin
              arg_array = []
                validate_object(serviceSelector, AdwordsApi::V201101::CampaignCriterionService::Selector)
                arg_array << convert_to_object(serviceSelector, AdwordsApi::V201101::CampaignCriterionService::Get,
                    'serviceSelector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::CampaignCriterionService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201101/CampaignCriterionService.html#mutate] method of the CampaignCriterionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/CampaignCriterionService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201101::CampaignCriterionService::CampaignCriterionOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201101::CampaignCriterionService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::CampaignCriterionService::Mutate.new(*arg_array)
