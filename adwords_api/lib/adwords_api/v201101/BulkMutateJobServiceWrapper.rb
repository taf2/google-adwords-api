require 'adwords_api/v201101/ServicedWrapperBase.rb'
  ...
  # library setup.
  require 'adwords_api/v201101/BulkMutateJobServiceDriver.rb'

  module AdwordsApi
    module V201101
      module BulkMutateJobService

        # Wrapper class for the v201101 BulkMutateJobService service.
        # This class is automatically generated.
        class BulkMutateJobServiceWrapper < ServerWrapperBase
          ...
          REGISTRY = AdwordsApi::V201101::BulkMutateJobService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201101::BulkMutateJobService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201101::BulkMutateJobService
            @version = :v201101
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201101/BulkMutateJobService.html#get] method of the BulkMutateJobService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/BulkMutateJobService.html#get].
          #
          # Args:
            # - selector: AdwordsApi::V201101::BulkMutateJobService::BulkMutateJobSelector
            #
            # Returns:
            # - rval: SOAP::SOAPArray of AdwordsApi::V201101::BulkMutateJobService::BulkMutateJob
          #
          # Raises:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201101::BulkMutateJobService::BulkMutateJobSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201101::BulkMutateJobService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::BulkMutateJobService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201101/BulkMutateJobService.html#mutate] method of the BulkMutateJobService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/BulkMutateJobService.html#mutate].
          #
          # Args:
            # - operation: AdwordsApi::V201101::BulkMutateJobService::JobOperation
            #
            # Returns:
            # - rval: AdwordsApi::V201101::BulkMutateJobService::BulkMutateJob
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def mutate(operation)
            begin
              arg_array = []
                validate_object(operation, AdwordsApi::V201101::BulkMutateJobService::JobOperation)
                arg_array << convert_to_object(operation, AdwordsApi::V201101::BulkMutateJobService::Mutate,
                    'operation')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::BulkMutateJobService::Mutate.new(*arg_array)
