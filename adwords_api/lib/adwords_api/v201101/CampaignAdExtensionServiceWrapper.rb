require 'adwords_api/v201101/ServicedWrapperBase.rb'
  ...
  # library setup.
  require 'adwords_api/v201101/CampaignAdExtensionServiceDriver.rb'

  module AdwordsApi
    module V201101
      module CampaignAdExtensionService

        # Wrapper class for the v201101 CampaignAdExtensionService service.
        # This class is automatically generated.
        class CampaignAdExtensionServiceWrapper < ServerWrapperBase
          ...
          REGISTRY = AdwordsApi::V201101::CampaignAdExtensionService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201101::CampaignAdExtensionService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201101::CampaignAdExtensionService
            @version = :v201101
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201101/CampaignAdExtensionService.html#get] method of the CampaignAdExtensionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/CampaignAdExtensionService.html#get].
          #
          # Args:
          ...
          def get(serviceSelector)
            begin
              arg_array = []
                validate_object(serviceSelector, AdwordsApi::V201101::CampaignAdExtensionService::Selector)
                arg_array << convert_to_object(serviceSelector, AdwordsApi::V201101::CampaignAdExtensionService::Get,
                    'serviceSelector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::CampaignAdExtensionService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201101/CampaignAdExtensionService.html#mutate] method of the CampaignAdExtensionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/CampaignAdExtensionService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201101::CampaignAdExtensionService::CampaignAdExtensionOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201101::CampaignAdExtensionService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::CampaignAdExtensionService::Mutate.new(*arg_array)
