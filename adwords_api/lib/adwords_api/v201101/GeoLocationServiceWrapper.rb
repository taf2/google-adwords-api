require 'adwords_api/v201101/ServicedWrapperBase.rb'
  ...
  # library setup.
  require 'adwords_api/v201101/GeoLocationServiceDriver.rb'

  module AdwordsApi
    module V201101
      module GeoLocationService

        # Wrapper class for the v201101 GeoLocationService service.
        # This class is automatically generated.
        class GeoLocationServiceWrapper < ServerWrapperBase
          ...
          REGISTRY = AdwordsApi::V201101::GeoLocationService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201101::GeoLocationService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201101::GeoLocationService
            @version = :v201101
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201101/GeoLocationService.html#get] method of the GeoLocationService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/GeoLocationService.html#get].
          #
          # Args:
            # - selector: AdwordsApi::V201101::GeoLocationService::GeoLocationSelector
            #
            # Returns:
            # - rval: SOAP::SOAPArray of AdwordsApi::V201101::GeoLocationService::GeoLocation
          #
          # Raises:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201101::GeoLocationService::GeoLocationSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201101::GeoLocationService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::GeoLocationService::Get.new(*arg_array)
