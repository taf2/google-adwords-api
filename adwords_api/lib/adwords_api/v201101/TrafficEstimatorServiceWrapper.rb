require 'adwords_api/v201101/ServicedWrapperBase.rb'
  ...
  # library setup.
  require 'adwords_api/v201101/TrafficEstimatorServiceDriver.rb'

  module AdwordsApi
    module V201101
      module TrafficEstimatorService

        # Wrapper class for the v201101 TrafficEstimatorService service.
        # This class is automatically generated.
        class TrafficEstimatorServiceWrapper < ServerWrapperBase
          ...
          REGISTRY = AdwordsApi::V201101::TrafficEstimatorService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201101::TrafficEstimatorService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201101::TrafficEstimatorService
            @version = :v201101
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201101/TrafficEstimatorService.html#get] method of the TrafficEstimatorService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/TrafficEstimatorService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201101::TrafficEstimatorService::TrafficEstimatorSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201101::TrafficEstimatorService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::TrafficEstimatorService::Get.new(*arg_array)
