require 'adwords_api/v201101/ServicedWrapperBase.rb'
  ...
  # library setup.
  require 'adwords_api/v201101/CampaignTargetServiceDriver.rb'

  module AdwordsApi
    module V201101
      module CampaignTargetService

        # Wrapper class for the v201101 CampaignTargetService service.
        # This class is automatically generated.
        class CampaignTargetServiceWrapper < ServerWrapperBase
          ...
          REGISTRY = AdwordsApi::V201101::CampaignTargetService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201101::CampaignTargetService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201101::CampaignTargetService
            @version = :v201101
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201101/CampaignTargetService.html#get] method of the CampaignTargetService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/CampaignTargetService.html#get].
          #
          # Args:
            # - selector: AdwordsApi::V201101::CampaignTargetService::CampaignTargetSelector
            #
            # Returns:
            # - rval: AdwordsApi::V201101::CampaignTargetService::CampaignTargetPage
          #
          # Raises:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201101::CampaignTargetService::CampaignTargetSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201101::CampaignTargetService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::CampaignTargetService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201101/CampaignTargetService.html#mutate] method of the CampaignTargetService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/CampaignTargetService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201101::CampaignTargetService::CampaignTargetOperation
            #
            # Returns:
            # - rval: AdwordsApi::V201101::CampaignTargetService::CampaignTargetReturnValue
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201101::CampaignTargetService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::CampaignTargetService::Mutate.new(*arg_array)
