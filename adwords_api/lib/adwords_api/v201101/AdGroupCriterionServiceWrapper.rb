require 'adwords_api/v201101/ServicedWrapperBase.rb'
  ...
  # library setup.
  require 'adwords_api/v201101/AdGroupCriterionServiceDriver.rb'

  module AdwordsApi
    module V201101
      module AdGroupCriterionService

        # Wrapper class for the v201101 AdGroupCriterionService service.
        # This class is automatically generated.
        class AdGroupCriterionServiceWrapper < ServerWrapperBase
          ...
          REGISTRY = AdwordsApi::V201101::AdGroupCriterionService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201101::AdGroupCriterionService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201101::AdGroupCriterionService
            @version = :v201101
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201101/AdGroupCriterionService.html#get] method of the AdGroupCriterionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/AdGroupCriterionService.html#get].
          #
          # Args:
          ...
          def get(serviceSelector)
            begin
              arg_array = []
                validate_object(serviceSelector, AdwordsApi::V201101::AdGroupCriterionService::Selector)
                arg_array << convert_to_object(serviceSelector, AdwordsApi::V201101::AdGroupCriterionService::Get,
                    'serviceSelector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::AdGroupCriterionService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201101/AdGroupCriterionService.html#mutate] method of the AdGroupCriterionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/AdGroupCriterionService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201101::AdGroupCriterionService::AdGroupCriterionOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201101::AdGroupCriterionService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::AdGroupCriterionService::Mutate.new(*arg_array)
