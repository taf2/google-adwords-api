require 'adwords_api/v201101/ServicedWrapperBase.rb'
  ...
  # library setup.
  require 'adwords_api/v201101/AdGroupServiceDriver.rb'

  module AdwordsApi
    module V201101
      module AdGroupService

        # Wrapper class for the v201101 AdGroupService service.
        # This class is automatically generated.
        class AdGroupServiceWrapper < ServerWrapperBase
          ...
          REGISTRY = AdwordsApi::V201101::AdGroupService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201101::AdGroupService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201101::AdGroupService
            @version = :v201101
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201101/AdGroupService.html#get] method of the AdGroupService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/AdGroupService.html#get].
          #
          # Args:
          ...
          def get(serviceSelector)
            begin
              arg_array = []
                validate_object(serviceSelector, AdwordsApi::V201101::AdGroupService::Selector)
                arg_array << convert_to_object(serviceSelector, AdwordsApi::V201101::AdGroupService::Get,
                    'serviceSelector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::AdGroupService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201101/AdGroupService.html#mutate] method of the AdGroupService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/AdGroupService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201101::AdGroupService::AdGroupOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201101::AdGroupService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::AdGroupService::Mutate.new(*arg_array)
