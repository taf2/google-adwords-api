require 'adwords_api/v201101/ServicedWrapperBase.rb'
  ...
  # library setup.
  require 'adwords_api/v201101/TargetingIdeaServiceDriver.rb'

  module AdwordsApi
    module V201101
      module TargetingIdeaService

        # Wrapper class for the v201101 TargetingIdeaService service.
        # This class is automatically generated.
        class TargetingIdeaServiceWrapper < ServerWrapperBase
          ...
          REGISTRY = AdwordsApi::V201101::TargetingIdeaService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201101::TargetingIdeaService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201101::TargetingIdeaService
            @version = :v201101
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201101/TargetingIdeaService.html#get] method of the TargetingIdeaService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/TargetingIdeaService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201101::TargetingIdeaService::TargetingIdeaSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201101::TargetingIdeaService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::TargetingIdeaService::Get.new(*arg_array)
          ...
          # Calls the {getBulkKeywordIdeas}[http://code.google.com/apis/adwords/docs/reference/v201101/TargetingIdeaService.html#getBulkKeywordIdeas] method of the TargetingIdeaService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/TargetingIdeaService.html#getBulkKeywordIdeas].
          #
          # Args:
            # - selector: AdwordsApi::V201101::TargetingIdeaService::TargetingIdeaSelector
            #
          ...
          def getBulkKeywordIdeas(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201101::TargetingIdeaService::TargetingIdeaSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201101::TargetingIdeaService::GetBulkKeywordIdeas,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::TargetingIdeaService::GetBulkKeywordIdeas.new(*arg_array)
              reply = convert_from_object(@driver.getBulkKeywordIdeas(obj))
              reply = reply[:rval] if reply.include?(:rval)
              return reply
            rescue SOAP::FaultError => fault
              raise AdwordsApi::Errors.create_api_exception(fault,
          ...
          alias get_bulk_keyword_ideas getBulkKeywordIdeas
