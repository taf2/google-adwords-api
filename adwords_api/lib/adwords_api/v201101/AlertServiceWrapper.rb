require 'adwords_api/v201101/ServicedWrapperBase.rb'
  ...
  # library setup.
  require 'adwords_api/v201101/AlertServiceDriver.rb'

  module AdwordsApi
    module V201101
      module AlertService

        # Wrapper class for the v201101 AlertService service.
        # This class is automatically generated.
        class AlertServiceWrapper < ServerWrapperBase
          ...
          REGISTRY = AdwordsApi::V201101::AlertService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201101::AlertService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201101::AlertService
            @version = :v201101
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201101/AlertService.html#get] method of the AlertService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/AlertService.html#get].
          #
          # Args:
            # - selector: AdwordsApi::V201101::AlertService::AlertSelector
            #
            # Returns:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201101::AlertService::AlertSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201101::AlertService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::AlertService::Get.new(*arg_array)
