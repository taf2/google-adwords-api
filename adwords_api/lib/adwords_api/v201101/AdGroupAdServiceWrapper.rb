require 'adwords_api/v201101/ServicedWrapperBase.rb'
  ...
  # library setup.
  require 'adwords_api/v201101/AdGroupAdServiceDriver.rb'

  module AdwordsApi
    module V201101
      module AdGroupAdService

        # Wrapper class for the v201101 AdGroupAdService service.
        # This class is automatically generated.
        class AdGroupAdServiceWrapper < ServerWrapperBase
          ...
          REGISTRY = AdwordsApi::V201101::AdGroupAdService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201101::AdGroupAdService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201101::AdGroupAdService
            @version = :v201101
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201101/AdGroupAdService.html#get] method of the AdGroupAdService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/AdGroupAdService.html#get].
          #
          # Args:
            # - serviceSelector: AdwordsApi::V201101::AdGroupAdService::Selector
            #
            # Returns:
            # - rval: AdwordsApi::V201101::AdGroupAdService::AdGroupAdPage
          #
          # Raises:
          ...
          def get(serviceSelector)
            begin
              arg_array = []
                validate_object(serviceSelector, AdwordsApi::V201101::AdGroupAdService::Selector)
                arg_array << convert_to_object(serviceSelector, AdwordsApi::V201101::AdGroupAdService::Get,
                    'serviceSelector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::AdGroupAdService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201101/AdGroupAdService.html#mutate] method of the AdGroupAdService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/AdGroupAdService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201101::AdGroupAdService::AdGroupAdOperation
            #
            # Returns:
            # - rval: AdwordsApi::V201101::AdGroupAdService::AdGroupAdReturnValue
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201101::AdGroupAdService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::AdGroupAdService::Mutate.new(*arg_array)
