require 'adwords_api/v201101/ServicedWrapperBase.rb'
  ...
  # library setup.
  require 'adwords_api/v201101/MediaServiceDriver.rb'

  module AdwordsApi
    module V201101
      module MediaService

        # Wrapper class for the v201101 MediaService service.
        # This class is automatically generated.
        class MediaServiceWrapper < ServerWrapperBase
          ...
          REGISTRY = AdwordsApi::V201101::MediaService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201101::MediaService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201101::MediaService
            @version = :v201101
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201101/MediaService.html#get] method of the MediaService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/MediaService.html#get].
          #
          # Args:
          ...
          def get(serviceSelector)
            begin
              arg_array = []
                validate_object(serviceSelector, AdwordsApi::V201101::MediaService::Selector)
                arg_array << convert_to_object(serviceSelector, AdwordsApi::V201101::MediaService::Get,
                    'serviceSelector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::MediaService::Get.new(*arg_array)
          ...
          # Calls the {upload}[http://code.google.com/apis/adwords/docs/reference/v201101/MediaService.html#upload] method of the MediaService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/MediaService.html#upload].
          #
          # Args:
            # - media: SOAP::SOAPArray of AdwordsApi::V201101::MediaService::Media
            #
            # Returns:
            # - rval: SOAP::SOAPArray of AdwordsApi::V201101::MediaService::Media
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def upload(media)
            begin
              arg_array = []
                validate_object(media, SOAP::SOAPArray)
                arg_array << convert_to_object(media, AdwordsApi::V201101::MediaService::Upload,
                    'media')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::MediaService::Upload.new(*arg_array)
              reply = convert_from_object(@driver.upload(obj))
              reply = reply[:rval] if reply.include?(:rval)
              return reply
            rescue SOAP::FaultError => fault
              raise AdwordsApi::Errors.create_api_exception(fault,
