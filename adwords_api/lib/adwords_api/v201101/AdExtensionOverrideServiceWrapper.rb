    ...
    module V201101
      module AdExtensionOverrideService
        ...
        class AdExtensionOverrideServiceWrapper < ServerWrapperBase
          ...
          REGISTRY = AdwordsApi::V201101::AdExtensionOverrideService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201101::AdExtensionOverrideService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201101::AdExtensionOverrideService
            @version = :v201101
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201101/AdExtensionOverrideService.html#get] method of the AdExtensionOverrideService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/AdExtensionOverrideService.html#get].
          #
          # Args:
            # - selector: AdwordsApi::V201101::AdExtensionOverrideService::AdExtensionOverrideSelector
            #
            # Returns:
            # - rval: AdwordsApi::V201101::AdExtensionOverrideService::AdExtensionOverridePage
          #
          # Raises:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201101::AdExtensionOverrideService::AdExtensionOverrideSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201101::AdExtensionOverrideService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::AdExtensionOverrideService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201101/AdExtensionOverrideService.html#mutate] method of the AdExtensionOverrideService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/AdExtensionOverrideService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201101::AdExtensionOverrideService::AdExtensionOverrideOperation
            #
            # Returns:
            # - rval: AdwordsApi::V201101::AdExtensionOverrideService::AdExtensionOverrideReturnValue
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201101::AdExtensionOverrideService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::AdExtensionOverrideService::Mutate.new(*arg_array)
