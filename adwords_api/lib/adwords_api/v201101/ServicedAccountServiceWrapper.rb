require 'adwords_api/v201101/ServicedWrapperBase.rb'
  ...
  # library setup.
  require 'adwords_api/v201101/ServicedAccountServiceDriver.rb'

  module AdwordsApi
    module V201101
      module ServicedAccountService

        # Wrapper class for the v201101 ServicedAccountService service.
        # This class is automatically generated.
        class ServicedAccountServiceWrapper < ServerWrapperBase
          ...
          REGISTRY = AdwordsApi::V201101::ServicedAccountService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201101::ServicedAccountService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201101::ServicedAccountService
            @version = :v201101
            @service = :ServicedAccountService
          end
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201101/ServicedAccountService.html#get] method of the ServicedAccountService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201101/ServicedAccountService.html#get].
          #
          # Args:
            # - selector: AdwordsApi::V201101::ServicedAccountService::ServicedAccountSelector
            #
            # Returns:
            # - rval: AdwordsApi::V201101::ServicedAccountService::ServicedAccountGraph
          #
          # Raises:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201101::ServicedAccountService::ServicedAccountSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201101::ServicedAccountService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201101::ServicedAccountService::Get.new(*arg_array)
